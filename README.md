...
![catalog](https://github.com/Zrazhevskii/ra16-diploma_frontend/blob/main/public/catalog.png)
...
При заполнении этого поля отправляется запрос вида: GET [http://localhost:7070/api/items?q=](http://localhost:7070/api/items?q=)<текст в строке поиска>. При этом все правила относительно категории кнопки «Загрузить ещё» сохраняются.
...
![search-header](https://github.com/Zrazhevskii/ra16-diploma_frontend/blob/main/public/search-comments.png)

По умолчанию поисковое поле скрыто, отображается только иконка:

![search-cloused](https://github.com/Zrazhevskii/ra16-diploma_frontend/blob/main/public/search-closed.png)
...
![search-catalog-comments](https://github.com/Zrazhevskii/ra16-diploma_frontend/blob/main/public/search-catalog-comments.png)
...
![card-widget](https://github.com/Zrazhevskii/ra16-diploma_frontend/blob/main/public/catalog-item.png)
...
![card-item-comments](https://github.com/Zrazhevskii/ra16-diploma_frontend/blob/main/public/catalog-item-comments.png)
...
![cart-comments](https://github.com/Zrazhevskii/ra16-diploma_frontend/blob/main/public/cart-comments.png)
...
![cart](https://github.com/Zrazhevskii/ra16-diploma_frontend/blob/main/public/cart-widget.png)
